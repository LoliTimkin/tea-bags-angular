$(document).ready(function(event){
    ...
    $('.single-item').slick({
        arrows: true,
        prevArrow:"<img class='a-left control-c prev slick-prev' src='../images/arrow-prev.png'>",
        nextArrow: "<img class='a-right control-c next slick-next' src='../images/arrow-next.png'>"
        });
    $( "#accordion" ).accordion({
